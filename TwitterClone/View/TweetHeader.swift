...
//  TwitterClone
//
//  Created by Finn Christoffer Kurniawan on 20/12/22.
//
...
class TweetHeader: UICollectionReusableView {
    ...
    private lazy var statsView: UIView = {
       let view = UIView()
        ...
        devider1.anchor(top: view.topAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingRight: 8, height: 1.0)
